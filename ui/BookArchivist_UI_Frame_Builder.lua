...
--- Legacy synchronous create (for fallback only)
--- DO NOT USE - Causes game freeze
function FrameUI:CreateLegacy(opts)
	opts = opts or {}
	...
	-- PortraitFrameTemplate already makes frame draggable
