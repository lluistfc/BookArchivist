...
function ReaderUI:ShowSharePopup(exportStr)
	...
	local shareFrame = state.shareFrame
	if not shareFrame then
		local createFrame = (ctx and ctx.createFrame) or CreateFrame
