...
Locales.deDE = {
  ...
  ["OPTIONS_IMPORT_STATUS_SUMMARY"] = "Importiert: %d neu, %d zusammengeführt",
	...
	["OPTIONS_TOOLTIP_TOOLTIP"] = "Wenn aktiviert, zeigen lesbare Gegenstände, deren Text für diesen Charakter gespeichert wurde, eine zusätzliche Zeile 'Book Archivist: Archiviert' in ihrem Tooltip.",	["OPTIONS_RELOAD_REQUIRED"] = "Sprache geändert! Hauptoberfläche aktualisiert. Geben Sie /reload ein, wenn Sie dieses Einstellungsfenster auch aktualisieren möchten.",  ["OPTIONS_DEBUG_LABEL"] = "Debug-Modus",
