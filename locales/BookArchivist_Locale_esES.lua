...
Locales.esES = {
  ...
  ["OPTIONS_IMPORT_STATUS_SUMMARY"] = "Importados: %d nuevos, %d combinados",
	...
	["OPTIONS_TOOLTIP_TOOLTIP"] = "Cuando está activado, los elementos legibles cuyo texto se ha guardado para este personaje mostrarán una línea adicional 'Book Archivist: Archivado' en su descripción.",	["OPTIONS_RELOAD_REQUIRED"] = "¡Idioma de la interfaz principal actualizado!\n\n¿Recargar ahora para actualizar este panel?",	["OPTIONS_RELOAD_NOW"] = "Recargar ahora",
	["OPTIONS_RELOAD_LATER"] = "Ahora no",  ["OPTIONS_DEBUG_LABEL"] = "Modo de depuración",
