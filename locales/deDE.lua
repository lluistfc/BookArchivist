...
Locales.deDE = {
	...
	["OPTIONS_IMPORT_STATUS_ERROR"] = "Importfehler (%s): %s",
	...
	["OPTIONS_RELOAD_REQUIRED"] = "Hauptoberfläche-Sprache aktualisiert!\n\nJetzt neu laden, um dieses Fenster zu aktualisieren?",
	["OPTIONS_RELOAD_NOW"] = "Jetzt neu laden",
	["OPTIONS_RELOAD_LATER"] = "Nicht jetzt",
