...
Locales.enUS = {
	...
	["RANDOM_BOOK_TOOLTIP"] = "Open a random book from your library",
	...
	["OPTIONS_IMPORT_EXPORT_DEBUG_BUTTON"] = "Import / Export / Debug",
	["OPTIONS_IMPORT_EXPORT_DEBUG_TOOLTIP"] = "Opens a separate window for importing and exporting books.",
	...
	["OPTIONS_RELOAD_REQUIRED"] = "Main UI language updated!\n\nReload now to update this settings panel?",
	["OPTIONS_RELOAD_NOW"] = "Reload Now",
	["OPTIONS_RELOAD_LATER"] = "Not Now",
