...
local function setupIntegration()
	...
	local mockAddon = {
		...
		SetLastBookId = function(self, id)
			self.__lastBookId = id
		end,
		GetLastBookId = function(self)
			return self.__lastBookId
		end,
		IsResumeLastPageEnabled = function()
			return false
		end,
	...
	local function createMockWidget(widgetType)
		return {
			...
			IsObjectType = function(self, type)
	...
	-- Getters/setters
	sharedContext.getSelectedKey = function()
		return sharedContext.selectedKey
	end
	...
	-- Addon
	sharedContext.getAddon = function()
		return mockAddon
	end

	-- Widgets
	sharedContext.getWidget = function(name)
		return readerWidgets[name]
	end
	...
	-- UI Frame
	sharedContext.getUIFrame = function()
		return { __contentReady = true }
	end
	...
	sharedContext.fmtTime = function(ts)
		return "2026-01-11 10:00"
	end
